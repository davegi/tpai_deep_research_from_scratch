...
def test_record_and_continue_mixed_results():
    ...
    async def run():
        ...
        # Should continue (not forced end) or may indicate supervisor step; ensure successful results are present Ensure command update
        # exists and contains evidence of successful results
